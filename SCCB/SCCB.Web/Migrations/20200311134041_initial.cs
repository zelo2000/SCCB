        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupId = table.Column<Guid>(nullable: false),
                    LectorId = table.Column<Guid>(nullable: false),
                    IsDenominator = table.Column<bool>(nullable: false),
                    IsEnumerator = table.Column<bool>(nullable: false),
                    Weekday = table.Column<string>(maxLength: 9, nullable: false),
                    LessonNumber = table.Column<string>(nullable: false),
                    ClassroomId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
